...
namespace MDL_PFEP.ComponentPackingIntruction.Models
{
    public class PackingInstructionFilterObject
    {
        public int Id { get; set; }

        [Display(Name = "Wersja Instrukcji")]
        ...
        [Display(Name = "Numer wyrobu klienta")]
