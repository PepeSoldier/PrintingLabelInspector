...
{
    public class AppClientElectroluxPLS : AppClientApbstract
    {
        public AppClientElectroluxPLS() : base()
        {
            ac = new MenuAccessCode[] {
                    ...
                    MenuAccessCode.ILOGIS_CONFIG_CONTRACTORS,
                };
        }
        ...
        {
            SettingsILOGIS.ShowPackagePriceColumn = true;
        }
    }
}