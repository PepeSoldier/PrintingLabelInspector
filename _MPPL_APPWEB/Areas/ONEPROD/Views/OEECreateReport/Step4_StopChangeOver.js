function StopChangeOverGrid(gridDivSelector, reportId, machineId, defaultHour) {
    ...
    var selectList = gridHelperReasons.GetList(false, { machineId: machineId, entryType: 21 }).responseJSON;

    var gridHelper = new GridHelper("Stoppage", "/ONEPROD/OEECreateReport");
    gridHelper.SetFilter({ ReportId: reportId, EntryType: 21 });
    
    var sgh = new StopGridHelper(divSelector, reportId, gridHelper.DB, selectList, 21, "OPT(min)", defaultHour);
