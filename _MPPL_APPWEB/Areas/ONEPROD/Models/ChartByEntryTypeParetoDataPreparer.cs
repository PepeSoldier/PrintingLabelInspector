...
{
    public class ChartByEntryTypeParetoDataPreparer : ChartDataPreparer
    {
        ...
        public ChartByEntryTypeParetoDataPreparer(List<ParetoModel> paretoModelList, OeeCalculationModel oeeCalc, EnumEntryType entryType)
        {
        ...
        public virtual ChartViewModel PrepareChartData(string title, int limit = 1000, int languageId = 1)
        {
            ...
            if (30 <= (int)entryType && (int)entryType < 40) {
        ...
        private decimal EstimateOee(decimal stoppageTime)
        {
