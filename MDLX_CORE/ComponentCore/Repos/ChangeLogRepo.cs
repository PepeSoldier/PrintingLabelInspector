...
namespace XLIB_COMMON.Repo.Base
{
    public class ChangeLogRepo : RepoGenericAbstract<ChangeLog>
    {
        ...
        //public void AddChangeLog(int objectId, int parentObjectId, string objClassName, string fieldName, string fieldDisplayName, string oldVal, string newVal, DateTime dtNow, string userId)
        //{
        //    //RepoChangeLog repoChangeLog = new RepoChangeLog(db);            
        //    oldVal = oldVal != null ? oldVal : string.Empty;
        //    newVal = newVal != null ? newVal : string.Empty;

        //    if (oldVal.Length < 255 && newVal.Length < 255)
        //    {
        //        ChangeLog chl = new ChangeLog
        //        {
        //            ObjectId = objectId,
