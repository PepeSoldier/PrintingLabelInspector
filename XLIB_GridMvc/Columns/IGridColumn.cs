...
namespace GridMvc.Columns
{
    ...
    {
        //custom
        IGridColumn<T> Editable(bool editable);
        IGridColumn<T> Editable(bool editable, string type);
        IGridColumn<T> Editable(bool editable, string type, string items);
        IGridColumn<T> EditActionColumn(string openActionUrl, string saveActionUrl, string deleteActionUrl);
        IGridColumn<T> EditActionColumn(string openActionUrl, string saveActionUrl, string deleteActionUrl, bool canInsert);
        IGridColumn<T> OpenActionColumn(string openActionUrl);
        //*custom
    ...
    {
        //custom
        bool EditableColumn { get; set; }
        string EditableColumnType { get; set; }
        string EditableColumnItems { get; set; }
        string SelectDisplayValue { get; set; }
        string DeleteActionUrl { get; set; }
        string SaveActionUrl { get; set; }
        string OpenActionUrl { get; set; }
        bool ShowManageBtncolumn { get; set; }
