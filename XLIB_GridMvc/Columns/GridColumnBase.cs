...
namespace GridMvc.Columns
{
    public abstract class GridColumnBase<T> : IGridColumn<T>
    {
        ...
        public string EditableColumnType { get; set; }
        public string EditableColumnItems { get; set; }
        public string SelectDisplayValue { get; set; }
        public string DeleteActionUrl { get; set; }
        public string SaveActionUrl { get; set; }
        public string OpenActionUrl { get; set; }
        public bool ShowManageBtncolumn { get; set; }
        ...
        public IGridColumn<T> Editable(bool editable)
        {
            return Editable(editable, "text");
        }

        public IGridColumn<T> Editable(bool editable, string type)
        {
            return Editable(editable, type, "");
        }

        public IGridColumn<T> Editable(bool editable, string type, string items)
        {
            return Editable(editable, type, items, "");
        }

        public IGridColumn<T> Editable(bool editable, string type, string items, string value)
        {
            EditableColumn = editable;
            EditableColumnType = type;
            EditableColumnItems = items;
            SelectDisplayValue = value;
            return this;
        }

        public IGridColumn<T> EditActionColumn(string openActionUrl, string saveActionUrl = "", string deleteActionUrl = "")
        {
            return EditActionColumn(openActionUrl, saveActionUrl, deleteActionUrl, true);
        }

        public IGridColumn<T> EditActionColumn(string openActionUrl, string saveActionUrl = "", string deleteActionUrl = "", bool canInsert = true)
        {
            OpenActionUrl = openActionUrl;
            DeleteActionUrl = deleteActionUrl;
            SaveActionUrl = saveActionUrl;
            ShowManageBtncolumn = true;
            CanInsert = canInsert;
            return this;
        }

        public IGridColumn<T> OpenActionColumn(string openActionUrl)
        {
            OpenActionUrl = openActionUrl;
            return this;
        }
