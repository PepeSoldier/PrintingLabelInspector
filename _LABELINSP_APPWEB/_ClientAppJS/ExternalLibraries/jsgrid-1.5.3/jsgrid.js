...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        filtering: false,
        formInlineRowRenderer: null,
        formInlineRowClass: "jsgrid-filter-row",
        ...
        _createHeader: function() {
            var $headerRow = this._headerRow = this._createHeaderRow(),
                $formInlineRow = this._formInlineRow = this._createformInlineRow(),
                $insertRow = this._insertRow = this._createInsertRow();

            var $headerGrid = this._headerGrid = $("<table>").addClass(this.tableClass)
                .append($headerRow)
                .append($formInlineRow)
                .append($insertRow);
        ...
        _createformInlineRow: function() {
            if($.isFunction(this.formInlineRowRenderer))
                return $(this.renderTemplate(this.formInlineRowRenderer, this));

            var $result = $("<tr>").addClass(this.formInlineRowClass);
        ...
        _refreshFiltering: function() {
            this._formInlineRow.toggle(this.filtering);
        },
        ...
        _createPagerButton: function(text, css, handler) {
            var $link2 = $("<span>").addClass("dickens").html(text);
        ...
        clearFilter: function() {
            var $formInlineRow = this._createformInlineRow();
            this._formInlineRow.replaceWith($formInlineRow);
            this._formInlineRow = $formInlineRow;
            return this.search();
        },
