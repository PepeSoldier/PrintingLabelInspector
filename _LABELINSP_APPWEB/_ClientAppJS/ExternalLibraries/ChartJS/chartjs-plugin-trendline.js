...
var pluginTrendlineLinear = {
    beforeDraw: function (chartInstance) {
       ...
       // var trendline = chartInstance.options.trendlineLinear;

        for (var i = 0; i < chartInstance.data.datasets.length; i++) {
            if (chartInstance.data.datasets[i].trendlineLinear != null) {
...
function addFitter(datasetMeta, ctx, datasets, yScale) {
    ...
    style = (style !== undefined) ? style : "rgba(245,105,180, 0.8)";
